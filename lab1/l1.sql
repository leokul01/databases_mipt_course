...
VALUES 	('Пупкин Василий Пупкинович', 'Хирург', 'Конечности', '14'),
		...
		('Фокин Мартын Ильяович', 'Дерматолог', 'Общая', '30'),
		('Морозов Моисей Мэлсович', 'Радиолог', 'Конечности', '31'),
		('Горшков Юстиниан Николаевич', 'Стоматолог', 'Общая', '32'),
		('Суханов Карл Федотович', 'Эндокринолог', 'Общая', '33');
...
VALUES 	('Пациент 1', 'm', NOW(), '1234567890123456', 'AWESOME ADDRESS', '79011238943'),
		...
		('Пациент 4', 'm', TO_DATE('20181009','YYYYMMDD'), '4567890123456', 'ADDRESS 4', NULL),
		('Пациент 5', 'm', TO_DATE('20171109','YYYYMMDD'), '54567890123456', 'ADDRESS 5', NULL),
		('Пациент 6', 'f', TO_DATE('20161209','YYYYMMDD'), '6214567890123456', 'ADDRESS 6', '78111238953');
...
VALUES 	(1, 1, NOW(), 'Laziness'),
		...
		(2, 4, NOW(), 'Диагноз 4'),
		(3, 5, TO_TIMESTAMP('02/08/2017 10:59:00', 'MM/DD/YYYY HH24:MI:SS'), 'Parkinson'),
		(4, 6, TO_TIMESTAMP('02/08/2017 10:59:00', 'MM/DD/YYYY HH24:MI:SS'), 'Диагноз 6');
